...
export default function GuitarLessonsPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: COLORS.bg, color: COLORS.text, fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', overflowX: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 10, maxWidth: 1200, margin: '0 auto', padding: '80px 20px' }}>
        {/* Header Section */}
        <div style={{ textAlign: 'center', maxWidth: 800, margin: '0 auto 80px' }}>
          ...
          <h1 style={{ fontSize: 'clamp(2.5rem, 8vw, 4.5rem)', fontWeight: 900, letterSpacing: '-0.02em', marginBottom: 24, background: 'linear-gradient(to right, #fff, #8EA2B8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            MASTER THE <span style={{ color: COLORS.accent, WebkitTextFillColor: COLORS.accent }}>GUITAR</span>
          </h1>
          <p style={{ fontSize: '1.25rem', color: COLORS.textDim, lineHeight: 1.6 }}>
        ...
        {/* Features Grid */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 48, marginBottom: 120 }}>
          <div style={{ spaceY: 16 }}>
